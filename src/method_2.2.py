...
# In this Version more strictness has been added 
          ...
          #  print "smit",wordPairs
            ...
            for word in annotatedDict[sentence]:
                ...
                try:
                    ...
                    flg = 1
                if(flg==0):
                    if cosine_similarity > max_similarity1 and SequenceMatcher(None,word, wordPairs[0]).ratio() > SEQUENCE_SIMILARITY:
                        word1=word
                        flag1 = 1
                ...
                try:
                    ...
                    continue
                if cosine_similarity > max_similarity2 and SequenceMatcher(None,word, wordPairs[2]).ratio() > SEQUENCE_SIMILARITY:
                    word2=word
                    flag2 = 1
...
def calculateSimilarity(wordVectorDict):
    ...
    return similarityDict
def outputFilePath():
    if not os.path.exists(CURRENT_PATH+"/../output/Results_v2.2"):
        os.mkdir(CURRENT_PATH+"/../output/Results_v2.2")
    print CURRENT_PATH+"/../output/Results_v2.2/graph.gexf"
    return CURRENT_PATH+"/../output/Results_v2.2/graph.gexf"
#----Author : Ashish ends-------
